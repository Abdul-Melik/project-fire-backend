...
import { getEmployeesSchema, createEmployeeSchema, updateEmployeeSchema } from '../schemas/employeeSchemas';
...
router.get('/', validateResourceMiddleware(getEmployeesSchema), employeesController.getEmployees);
